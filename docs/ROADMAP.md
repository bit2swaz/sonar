...
- the repo has undergone external security review appropriate for the intended deployment# Sonar Roadmap
...
- recovery and rollback procedures are documented and rehearsed
- observability covers queue health, callback latency, proof failures, and data freshness
- the repo has undergone external security review appropriate for the intended deployment# roadmap
